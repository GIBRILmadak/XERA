...
async function getAllUsers(page = 0, limit = 200) {
...
async function getUserContent(userId, page = 0, limit = 200) {
    const from = page * limit;
    const to = from + limit - 1;
...
async function getUserContentPublic(userId, page = 0, limit = 200) {
    const from = page * limit;
    const to = from + limit - 1;
